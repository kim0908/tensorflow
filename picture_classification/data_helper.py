...
def main():
  data_sets = load_data()
  print('images_train',data_sets['images_train'].shape)
  print('labels_train',data_sets['labels_train'].shape)
  print('images_test',data_sets['images_test'].shape)
  print('labels_test',data_sets['labels_test'].shape)
